...
const styles = StyleSheet.create({
  ...
  logoSub: { fontSize: 13, fontWeight: 'bold', color: '#666', letterSpacing: 2, marginTop: 5 },
  title: { fontSize: 30, fontWeight: 'bold', marginBottom: 10 },
  subtitle: { fontSize: 18, color: '#666', marginBottom: 40, lineHeight: 20 },
  inputContainer: { marginBottom: 25 },
  labelRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 4 },
  inputLabel: { fontSize: 16, fontWeight: 'bold', color: '#333', letterSpacing: 1 },
  forgotText: { fontSize: 12, fontWeight: 'bold', color: '#888', textDecorationLine: 'underline' },
  ...
  footerLink: { fontSize: 16, fontWeight: 'bold', color: '#000' },
  dividerContainer: { flexDirection: 'row', alignItems: 'center', marginBottom: 20 },
  divider: { flex: 1, height: 1, backgroundColor: '#EEE' },
  dividerText: { fontSize: 12, color: '#888', marginHorizontal: 10, letterSpacing: 1 },
});
